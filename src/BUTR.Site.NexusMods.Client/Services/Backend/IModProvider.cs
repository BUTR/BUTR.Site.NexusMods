...
namespace BUTR.Site.NexusMods.Client.Services
{
    ...
    {
        Task<ModModelPagingResponse?> GetMods(int page, int pageSize, CancellationToken ct = default);
        ...
        Task<ModNexusModsManualLinkModelPagingResponse?> GetManualLinks(int page, int pageSize, CancellationToken ct = default);
        ...
        Task<UserAllowedModsModelPagingResponse?> GetAllowUserMods(int page, int pageSize, CancellationToken ct = default);
