...
public class NexusModsArticleEntityConfiguration : BaseEntityConfigurationWithTenant<NexusModsArticleEntity>
{
    ...
    {
        builder.Property(x => x.NexusModsArticleId).HasColumnName("nexusmods_article_entity_id").HasConversion<NexusModsArticleId.EfCoreValueConverter>().ValueGeneratedNever();
        builder.Property(x => x.Title).HasColumnName("title");
        builder.Property<NexusModsUserId>(nameof(NexusModsUserEntity.NexusModsUserId)).HasColumnName("author_id").HasConversion<NexusModsUserId.EfCoreValueConverter>();
