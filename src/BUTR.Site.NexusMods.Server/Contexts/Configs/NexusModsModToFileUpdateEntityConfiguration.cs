...
public class NexusModsModToFileUpdateEntityConfiguration : BaseEntityConfigurationWithTenant<NexusModsModToFileUpdateEntity>
{
    ...
    {
        builder.Property<NexusModsModId>(nameof(NexusModsModEntity.NexusModsModId)).HasColumnName("nexusmods_mod_file_update_id").HasConversion<NexusModsModId.EfCoreValueConverter>().ValueGeneratedNever();
