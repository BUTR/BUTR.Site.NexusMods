...
{
    public class SqlHelperUserCrashReports
    {
        /// <summary>
...
;";
        ...
        public SqlHelperUserCrashReports(IConfiguration configuration) => _configuration = configuration;
        ...
        public static async Task<UserCrashReportTableEntry> CreateUserCrashReportTableEntryFromReaderAsync(NpgsqlDataReader reader, CancellationToken ct = default)
        {
            ...
            return new UserCrashReportTableEntry
            {
                ...
                CrashReport = await SqlHelperCrashReports.CreateCrashReportTableEntryFromReaderAsync(reader, ct),
            };
        }
    }
}