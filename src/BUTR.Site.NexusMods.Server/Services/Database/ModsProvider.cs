...
;";
        ...
        public ModsProvider(ILogger<ModsProvider> logger, MainConnectionProvider connectionProvider)
        {
        ...
        public async Task<(int, List<ModTableEntry>)> GetPaginatedAsync(int userId, int skip, int take, CancellationToken ct = default)
        {
