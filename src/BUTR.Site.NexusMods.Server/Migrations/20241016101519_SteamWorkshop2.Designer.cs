...
namespace BUTR.Site.NexusMods.Server.Migrations
{
    ...
    [Migration("20241016101519_SteamWorkshop2")]
    partial class SteamWorkshop2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.CrashReportIgnoredFileEntity", b =>
                {
                    ...
                    b.Property<string>("CrashReportFileId")
                        .HasColumnType("text")
                        .HasColumnName("crash_report_file_ignored_id");

                    b.HasKey("TenantId", "CrashReportFileId");
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.CrashReportToModuleMetadataEntity", b =>
                {
                    ...
                    b.Property<byte>("InvolvedPosition")
                        .HasColumnType("smallint")
                        .HasColumnName("involved_position");
                    ...
                    b.Property<string>("SteamWorkshopModId")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.IntegrationGitHubTokensEntity", b =>
                {
                    b.Property<int>("NexusModsUserId")
                        .HasColumnType("integer")
                        .HasColumnName("integration_github_tokens_id");
                    ...
                    b.ToTable("integration_github_tokens", "integration");
                });
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.NexusModsModToModuleInfoHistoryGameVersionEntity", b =>
                {
                    b.Property<byte>("TenantId")
                        .HasColumnType("smallint")
                        .HasColumnName("tenant");
                    ...
                    b.Property<int>("NexusModsModId")
                        .HasColumnType("integer")
                        .HasColumnName("nexusmods_mod_module_info_history_game_version_id");
                    ...
                    b.ToTable("nexusmods_mod_module_info_history_game_version", "nexusmods_mod");
                });
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.NexusModsUserToIntegrationGitHubEntity", b =>
                {
                    b.Property<int>("NexusModsUserId")
                        .HasColumnType("integer")
                        .HasColumnName("nexusmods_user_to_github_id");
                    ...
                    b.ToTable("nexusmods_user_to_integration_github", "nexusmods_user");
                });
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.StatisticsCrashReportsPerDateEntity", b =>
                {
                    ...
                    b.HasKey("TenantId", "Date", "GameVersion", "NexusModsModId", "ModuleId", "ModuleVersion");
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.StatisticsCrashReportsPerDayEntity", b =>
                {
                    b.HasBaseType("BUTR.Site.NexusMods.Server.Models.Database.StatisticsCrashReportsPerDateEntity");

                    b.ToTable("crash_report_per_day", "statistics");
                });

            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.StatisticsCrashReportsPerMonthEntity", b =>
                {
                    b.HasBaseType("BUTR.Site.NexusMods.Server.Models.Database.StatisticsCrashReportsPerDateEntity");

                    b.ToTable("crash_report_per_month", "statistics");
                });
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.IntegrationGitHubTokensEntity", b =>
                {
                    b.HasOne("BUTR.Site.NexusMods.Server.Models.Database.NexusModsUserToIntegrationGitHubEntity", "UserToGitHub")
                        .WithOne("ToTokens")
                        .HasForeignKey("BUTR.Site.NexusMods.Server.Models.Database.IntegrationGitHubTokensEntity", "GitHubUserId")
                        .HasPrincipalKey("BUTR.Site.NexusMods.Server.Models.Database.NexusModsUserToIntegrationGitHubEntity", "GitHubUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BUTR.Site.NexusMods.Server.Models.Database.NexusModsUserEntity", "NexusModsUser")
                        .WithOne()
                        .HasForeignKey("BUTR.Site.NexusMods.Server.Models.Database.IntegrationGitHubTokensEntity", "NexusModsUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NexusModsUser");

                    b.Navigation("UserToGitHub");
                });
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.NexusModsModToModuleInfoHistoryGameVersionEntity", b =>
                {
                    ...
                    b.HasOne("BUTR.Site.NexusMods.Server.Models.Database.NexusModsModToModuleInfoHistoryEntity", "MainEntity")
                        .WithMany("GameVersions")
                        .HasForeignKey("TenantId", "NexusModsFileId", "NexusModsModId", "ModuleId", "ModuleVersion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_nexusmods_mod_module_info_history_game_version_nexusmods_m~1");
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.NexusModsUserToIntegrationGitHubEntity", b =>
                {
                    b.HasOne("BUTR.Site.NexusMods.Server.Models.Database.NexusModsUserEntity", "NexusModsUser")
                        .WithOne("ToGitHub")
                        .HasForeignKey("BUTR.Site.NexusMods.Server.Models.Database.NexusModsUserToIntegrationGitHubEntity", "NexusModsUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
