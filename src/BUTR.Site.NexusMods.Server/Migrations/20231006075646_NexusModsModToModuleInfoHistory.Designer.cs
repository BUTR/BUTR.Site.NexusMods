...
namespace BUTR.Site.NexusMods.Server.Migrations
{
    ...
    [Migration("20231006075646_NexusModsModToModuleInfoHistory")]
    partial class NexusModsModToModuleInfoHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BUTR.Site.NexusMods.Server.Models.Database.NexusModsModToModuleInfoHistoryEntity", b =>
                {
                    ...
                    b.HasKey("TenantId", "NexusModsModId", "ModuleId", "ModuleVersion");
